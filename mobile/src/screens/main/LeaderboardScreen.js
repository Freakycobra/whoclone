...
const TABS = ['💎 Richest', '👑 Top VIPs', '⭐ Most Popular', '🎁 Top Gifters'];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.yourRank}>
          <LinearGradient colors={['rgba(124,58,237,0.2)', 'rgba(236,72,153,0.2)']} style={styles.yourRankInner}>
            ...
            <Text style={styles.yourRankSub}>Keep chatting to climb the leaderboard!</Text>
          </LinearGradient>
        </View>
...
const styles = StyleSheet.create({
  ...
  listItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.backgroundSecondary, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: colors.cardBorder, gap: 12 },
